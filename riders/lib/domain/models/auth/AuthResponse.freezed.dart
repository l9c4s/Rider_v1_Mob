...
class _$AuthResponseImpl implements _AuthResponse {
  const _$AuthResponseImpl({
    ...
    @JsonKey(name: 'expiration') required this.expiration,
  ...
  @override
  String toString() {
    return 'AuthResponse(accessToken: $accessToken, expiration: $expiration, refreshToken: $refreshToken)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, expiration, refreshToken);
...
abstract class _AuthResponse implements AuthResponse {
  const factory _AuthResponse({
    ...
    @JsonKey(name: 'expiration') required final DateTime expiration,
